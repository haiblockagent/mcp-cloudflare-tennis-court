...
var AppContainer$1 = function AppContainer$1() {
  ...
  var onError = function onError(_ref112) {
    var errorType = _ref112.errorType;
    return function () {
      clearStytchSearchParams();
      dispatch({
        type: 'set_error_message_and_transition',
  ...
  var _useMutate13 = useMutate("stytch.magicLinks.authenticate", function (_, _ref113) {
      var token = _ref113.arg.token;
  ...
  var _useMutate14 = useMutate("stytch.oauth.authenticate", function (_, _ref114) {
  ...
  var _useMutate15 = useMutate("stytch.oauth.discovery.authenticate", function (_, _ref115) {
  ...
  var _useMutate16 = useMutate("stytch.sso.authenticate", function (_, _ref116) {
  ...
  var _useMutate17 = useMutate("stytch.magicLinks.discovery.authenticate", function (_, _ref117) {
...
var AppContainer = function AppContainer(_ref118) {
  var client = _ref118.client,
    styles = _ref118.styles,
    callbacks = _ref118.callbacks,
    config = _ref118.config;
  ...
  p$1(function () {
    ...
    readB2BInternals(client).bootstrap.getAsync().then(function (_ref119) {
      var displayWatermark = _ref119.displayWatermark;
...
var StytchB2BUIClient = /*#__PURE__*/function (_StytchB2BHeadlessCli) {
  ...
  _createClass(StytchB2BUIClient, [{
    key: "mount",
    value: function mount(_ref120) {
      var elementId = _ref120.elementId,
        styles = _ref120.styles,
        callbacks = _ref120.callbacks,
        config = _ref120.config;
      var _a;
