...
var extractErrorMessage = require('../extractErrorMessage-CUI3GjQ6.js');
var internal = require('../internal-BuXeSNhe.js');
...
var AppContainer = function AppContainer(_ref118) {
  ...
  extractErrorMessage.p(function () {
    ...
    internal.readB2BInternals(client).bootstrap.getAsync().then(function (_ref119) {
